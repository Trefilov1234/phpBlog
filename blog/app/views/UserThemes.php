    ...
    if($uploads)
    {
        ...
        foreach ($uploads as $upload) {
                ...
                <div class="card-body">
                  ...
                  <p class="card-text"> Создатель: '. $user['username'].'</p>
                  <a href="userTheme.php?uploadId='.$upload['id'].'" class="btn btn-dark">Подробнее</a>
                  <a href="editUpload.php?uploadId='.$upload['id'].'" class="btn btn-dark">Редактировать</a>
                  <a href="../../public/distributer.php?controller=upload&action=deleteUpload&uploadId='.$upload['id'].'" class="btn btn-dark" style="margin-top: 5px;">Удалить</a>
                </div>
              </div>';
